    ...
    <div class="col-12">
      <div class="card">
        ...
        <div class="card-header d-flex align-items-center justify-content-between">
          <h4 class="card-title">Halal PPIC</h4>
          <ul class="nav nav-tabs" id="halal-tabs">
            <li class="nav-item">
              <a class="nav-link active" data-bs-toggle="tab" href="#tab-pending" id="link-pending">Perlu Diproses</a>
            </li>
            <li class="nav-item">
              <a class="nav-link" data-bs-toggle="tab" href="#tab-history" id="link-history">Riwayat Halal</a>
            </li>
          </ul>
        </div>
...
{{-- Auto tab & focus (konsisten dengan halaman lain) --}}
<script>
(function(){
