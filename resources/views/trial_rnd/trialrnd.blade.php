    ...
    <div class="col-12">
      <div class="card">
        ...
        <div class="card-header d-flex align-items-center justify-content-between">
          ...
          <ul class="nav nav-tabs" id="trial-tabs">
            <li class="nav-item">
              <a class="nav-link active" data-bs-toggle="tab" href="#tab-pending" id="link-pending">Proses Trial</a>
            </li>
            <li class="nav-item">
              <a class="nav-link" data-bs-toggle="tab" href="#tab-history" id="link-history">Riwayat Trial</a>
            </li>
          </ul>
        </div>
                  ...
                  <tr data-row-id="{{ $r->id }}">
                    ...
                    <td class="text-end text-nowrap">
                      <a class="btn btn-outline-secondary btn-sm me-50"
                         href="{{ route('riwayat.detail', ['type'=>'pb','id'=>$r->id,'modul'=>'Trial R&D']) }}"
